// este es el archivo funciones.js CORREGIDO
...
function setDateRange(range) {
    ...
    loadData(); // Cambiar de applyFilters() a loadData()
}
...
async function loadData() {
    ...
    try {
        ...
        // Construir parámetros de filtro - CORREGIDO
        ...
        console.log('Cargando datos con fechas:', {dateFrom: dateFromValue, dateTo: dateToValue}); // DEBUG
        ...
        console.log('URL final:', `api.php?${params.toString()}`); // DEBUG
...
function updatePcFilter() {
    ...
    ` + allPcs.map(pc => `
        <div class="multi-select-option">
            <input type="checkbox" id="pc_${pc}" value="${pc}" checked onchange="loadData()">
...
// Esta función ya no es necesaria porque los datos vienen filtrados del servidor
function applyFilters() {
    // Simplemente redirigir a loadData() para obtener datos frescos del servidor
    loadData();
}
